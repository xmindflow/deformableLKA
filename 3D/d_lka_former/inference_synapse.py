...
def test(fold):
    path='/work/scratch/niggemeier/projects/project_UNETRpp/unetr_plus_plus/output_synapse_UNETRpp/unetr_pp/3d_fullres/Task002_Synapse/unetr_pp_trainer_synapse__unetr_pp_Plansv2.1/fold_0' #Task002_Synapse path
    ...
    file=path + 'inference_results/'+fold
